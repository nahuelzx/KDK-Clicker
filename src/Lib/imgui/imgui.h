...
namespace ImGui
{
    ...
    IMGUI_API bool          RenderModule(const char *label, const char *description, bool *v, int *key, bool *open, std::function<void()>
                                         renderCallback);
    IMGUI_API bool          RenderSettings(bool *open, std::function<void()> renderCallback);
    IMGUI_API void          RenderVoidModule(const bool *mask);
    IMGUI_API void          RenderVoidProfil();
    IMGUI_API bool          RenderProfil(const char *label, const char *date, const char *author, bool access);
    IMGUI_API bool          CustomSearchBar(const char* label, char* buffer, size_t bufferSize, float width);
    ...
    IMGUI_API bool          SliderScalarRange(const char *label, ImGuiDataType data_type,  void *p_min, void *p_max, const void *p_min_limit, const void *p_max_limit, const char *format, ImGuiSliderFlags ImGuiSliderFlags_Noneflags);
    ...
    bool NewButton(const char *label, const ImVec2 &size_arg);
