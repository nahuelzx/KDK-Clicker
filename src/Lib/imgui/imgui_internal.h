...
//#endif
    ...
    // Widgets
    IMGUI_API ImColor          getColorCustom(float alpha = 200.0f);
    IMGUI_API float getColorCustomValueR();
    IMGUI_API float getColorCustomValueG();
    IMGUI_API float getColorCustomValueB();
    IMGUI_API void setColorCustomValueR(float v);
    IMGUI_API void setColorCustomValueG(float v);
    IMGUI_API void setColorCustomValueB(float v);
    IMGUI_API bool isRainbow();
    IMGUI_API void setRainbow(bool value);
    IMGUI_API void          TextEx(const char* text, const char* text_end = NULL, ImGuiTextFlags flags = 0);
    IMGUI_API bool          ButtonEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          KeybindButton(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Keybind(const char* label, int* key);
    IMGUI_API void          Keybindbox(const char *label, bool *v, int *key);
    IMGUI_API void          KeybindText(const char* label, int *key);
    IMGUI_API void          Warn(const char* fmt, ...);
    IMGUI_API bool          CloseButton(ImGuiID id, const ImVec2& pos);
    IMGUI_API bool          HideButton(ImGuiID id, const ImVec2& pos);
    IMGUI_API bool          SettingsButton(ImGuiID id, const ImVec2& pos, ImTextureID texture);
